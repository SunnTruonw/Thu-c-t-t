...
class ValidateAddCategoryProduct extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rule=[
            ...
            "icon_path"=>"mimes:jpeg,jpg,png,svg,webp|nullable|file|max:3000",
            "active"=>"required",
    ...
    public function messages()
    {
        return     [
            ...
            "icon.mimes" => "icon category in jpeg,jpg,png,svg,webp",
            "icon_path.max" => "icon category size < 3mb",
            "avatar.mimes" => "avatar category in jpeg,jpg,png,svg,webp",
