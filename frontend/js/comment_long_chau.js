...
function sendComment() {
    $(document).on("click", "#sendComment", function () {
        ...
        $.ajax({
            ...
            headers: TOKEN,
            type: "POST",
            data: { product_id: $("#productId").val(), username: removeChar(name), phone: removeChar(phone), pageName: $("#pageName").val(), email: email, content: content, danh_xung: removeChar(danhXung) },
...
function sendReplyComment() {
    $(document).on("click", "#sendReplyComment", function () {
        ...
        $.ajax({
            ...
            headers: TOKEN,
            type: "POST",
            data: { id: removeChar(id), product_id: $("#productId").val(), username: removeChar(name), phone: removeChar(phone), email: email, content: content, danh_xung: removeChar(danhXung) },
            success: function (response) {
...
function sendReview() {
    $(document).on("click", ".send-review", function () {
        ...
        $.ajax({
            ...
            type: "POST",
            headers: TOKEN,
            data: { product_id: PRODUCT_ID, username: removeChar(name), phone: removeChar(phone), email: email, content: content, danh_xung: removeChar(danhXung), star: star },
            success: function (response) {
...
function sendReplyReview() {
    $(document).on("click", ".send-reply-review", function () {
        ...
        $.ajax({
            ...
            headers: TOKEN,
            type: "POST",
            data: { id: removeChar(id), product_id: PRODUCT_ID, username: removeChar(name), phone: removeChar(phone), email: removeChar(email), content: content, danh_xung: removeChar(danhXung), star: star },
            success: function (response) {
